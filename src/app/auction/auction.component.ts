...
export class AuctionComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        var SimpleAuctionContract = this.ethService.Eth.eth.contract(SimpleAuctionABI);
    
        var deployedContract = SimpleAuctionContract.new(30, this.ethService.Eth.eth.accounts[0], { data: SimpleAuctionBytecode, from: this.ethService.Eth.eth.accounts[0], gas: 3000000 });
