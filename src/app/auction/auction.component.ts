...
export class AuctionComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        var SimpleAuctionContract = this.web3Provider.web3.eth.contract(SimpleAuctionABI);

        this.deployedContract = SimpleAuctionContract.new(bidding_time, this.web3Provider.web3.eth.accounts[0], { data: SimpleAuctionBytecode, from: this.web3Provider.web3.eth.accounts[0], gas: 3000000 });
        ...
        var addressPromiseHandle = setInterval(() => {
            ...
            this.accounts = this.web3Provider.web3.eth.accounts;

            var auctionInterval = setInterval(() => {
                this.account_balance = this.web3Provider.web3.fromWei(this.web3Provider.web3.eth.getBalance(this.accounts[0]), 'ether');
                this.raised = this.web3Provider.web3.fromWei(this.web3Provider.web3.eth.getBalance(simpleAuctionInstance.address), 'ether');
                ...
                this.highest_bid = this.web3Provider.web3.fromWei(simpleAuctionInstance.highestBid(), 'ether');
                ...
                var actualTime = (new this.web3Provider.web3.BigNumber((new Date()).getTime() / 1000)).c[0];
