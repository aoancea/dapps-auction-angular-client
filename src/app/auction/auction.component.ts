...
export class AuctionComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        var deployedContract = SimpleAuctionContract.new(30, this.web3Provider.web3.eth.accounts[0], { data: SimpleAuctionBytecode, from: this.web3Provider.web3.eth.accounts[0], gas: 3000000 });
