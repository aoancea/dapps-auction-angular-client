(function () {
    ...
    */
    var angularLoadDelay = setTimeout(() => {
        ...
        var SimpleAuction = eth.contract(SimpleAuctionABI);
        ...
        //var deployedContract = SimpleAuction.new(biddingTime, accounts[0], { data: SimpleAuctionBytecode, from: web3.eth.accounts[0], gas: 3000000 });

        var simpleAuctionInstance = SimpleAuction.at('0xc3fd72ddb05f1c133a7fe915e77b55869dd6d740');
        ...
        var auctionInterval = setInterval(function updateAuctionHTML() {
            ...
            //var timeleft = (auctionStart[0].add(biddingTime[0])).sub(new Eth.BN((new Date()).getTime() / 1000));
